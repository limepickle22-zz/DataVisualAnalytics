...
class RandomForest(object):
    ...
    def _bootstrapping(self, XX, n):
        ...
        for _ in range(n):
            i = np.random.randint(0, len(XX))           ###Sample randomly with replacement
            samples.append(XX[i][:15])
            labels.append(XX[i][15])
    ...
    def fitting(self):
        ...
        for tree in self.decision_trees:
            tree.learn(self.bootstraps_datasets[0], self.bootstraps_labels[0])      ##had to use 0 index because of how it was appending
        pass      
    ...
    def voting(self, X):
        ...
        for record in X:
            ...
            for i in range(len(self.bootstraps_datasets)):
                dataset = self.bootstraps_datasets[0][i]                            ## see above about using 0 index
            ...
            if len(counts) == 0:
                ...
                y = np.append(y, np.random.randint(0, 1))                           ## choose randomly between 0 and 1
...
def main():
    ...
    forest_size = 10                                    ##tested with larger forests but did not see improvement
